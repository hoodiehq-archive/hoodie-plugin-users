...
UsernameChange.prototype.removeUserObject = function() {
  ...
  return Q.ninvoke(this.account.worker.usersDatabase, 'remove', this.oldProperties._id, this.oldProperties._rev)
  // .then( function () { console.log('removeUserObject good')})
  .fail( function (error) { console.log('removeUserObject ooops: %j', error)})
};
