...
// 
// 
UserAccount.prototype.handleSave = function(response) {
...
UserAccount.prototype.confirm = function() {
  ...
  this.save().otherwise( this._handleSignUpError.bind(this) );
};
...
UserAccount.prototype._handleSignUpError = function(error) {
  ...
  this.save().otherwise( this.handleErrorWithMessage("Error while confirming " + this.name + ", but couldn't update _users doc") );
